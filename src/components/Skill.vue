...
<v-container>
  <v-layout text-center justify-center>
    <v-flex xs12 class="content">
      ...
      <h2 class="font-weight-bold display-1 mb-3" color="primary">Skill</h2>

      <v-card>
        <v-toolbar flat color="primary" dark>
          <v-toolbar-title>スキルセット</v-toolbar-title>
        </v-toolbar>
        <v-tabs vertical>
          <v-tab>
          ...
          <v-tab-item>
            <v-layout wrap>
              <v-flex xs12 sm6 md4 lg3>
                <v-card flat class="mx-auto my-4" max-width="250">
                  <v-card-title class="justify-center">HTML</v-card-title>
              ...
              <v-flex xs12 sm6 md4 lg3>
                <v-card flat class="mx-auto my-4" max-width="250">
                  <v-card-title class="justify-center">Javascript</v-card-title>
                  <svg viewBox="0 0 128 128" width=64 height=64>
              ...
              <v-flex xs12 sm6 md4 lg3>
                <v-card flat class="mx-auto my-4" max-width="250">
                  <v-card-title class="justify-center">Typescript</v-card-title>
                  <svg viewBox="0 0 128 128" width=64 height=64>
                    <path id="original-2" data-name="original" class="cls-2"
              ...
              <v-flex xs12 sm6 md4 lg3>
                <v-card flat class="mx-auto my-4" max-width="250">
                  <v-card-title class="justify-center">CSS</v-card-title>
                  <svg viewBox="0 0 128 128" width=64 height=64>
              ...
              <v-flex xs12 sm6 md4 lg3>
                <v-card flat class="mx-auto my-4" max-width="250">
                  <v-card-title class="justify-center">Angular</v-card-title>
                  <svg viewBox="0 0 128 128" width=64 height=64>
              ...
              <v-flex xs12 sm6 md4 lg3>
                <v-card flat class="mx-auto my-4" max-width="250">
                  <v-card-title class="justify-center">React</v-card-title>
                  <svg viewBox="0 0 128 128" width=64 height=64>
                    <path
              ...
              <v-flex xs12 sm6 md4 lg3>
                <v-card flat class="mx-auto my-4" max-width="250">
                  <v-card-title class="justify-center">Vue.js</v-card-title>
                  <svg viewBox="0 0 128 128" width=64 height=64>
                    <path
              ...
              <v-flex xs12 sm6 md4 lg3>
                <v-card flat class="mx-auto my-4" max-width="250">
                  <v-card-title class="justify-center">Bootstrap</v-card-title>
                  <svg viewBox="0 0 128 128" width=64 height=64>
                    <path fill="#5B4282"
          ...
          <v-tab-item>
            <v-layout wrap>
              <v-flex xs12 sm6 md4 lg3>
                <v-card flat class="mx-auto my-4" max-width="250">
                  <v-card-title class="justify-center">Java</v-card-title>
                  <svg viewBox="0 0 128 128" width=64 height=64>
                    <path fill="#0074BD"
          ...
          <v-tab-item>
            <v-layout wrap>
              <v-flex xs12 sm6 md4 lg3>
                <v-card flat class="mx-auto my-4" max-width="250">
                  <v-card-title class="justify-center">Oracle</v-card-title>
                  <svg viewBox="0 0 128 128" width=64 height=64>
                    <path fill="#EA1B22"
          ...
          <v-tab-item>
            <v-layout wrap>
              <v-flex xs12 sm6 md4 lg3>
                <v-card flat class="mx-auto my-4" max-width="250">
                  <v-card-title class="justify-center">Git</v-card-title>
                  <svg viewBox="0 0 128 128" width=64 height=64>
                    <path fill="#F34F29"
              ...
              <v-flex xs12 sm6 md4 lg3>
                <v-card flat class="mx-auto my-4" max-width="250">
                  <v-card-title class="justify-center">Node.js</v-card-title>
                  <svg viewBox="0 0 128 128" width=64 height=64>
                    <path fill="#83CD29"
